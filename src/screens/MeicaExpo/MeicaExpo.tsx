    ...
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white overflow-hidden w-[1512px] h-[3265px] relative">
        ...
        <div className="absolute w-[1464px] h-[190px] top-8 left-7">
            ...
            <div className="relative w-[1456px] h-[170px] rounded-lg">
              <Card className="absolute w-[1456px] h-[170px] top-0 left-0 rounded-lg shadow-[0px_0px_4px_#737373]">
                <CardContent className="p-0">
                  <div className="absolute w-[166px] h-[38px] top-[58px] left-[1258px] rounded-[10px] [background:linear-gradient(90deg,rgba(16,162,201,1)_0%,rgba(0,52,92,1)_100%)] flex items-center justify-center">
                  ...
                  <div className="absolute w-[38px] h-[38px] top-[58px] left-[1197px] bg-[#00345c] rounded-[18.88px] flex items-center justify-center">
                    <div className="[font-family:'Inter',Helvetica] font-semibold text-white text-[16.4px] tracking-[0] leading-[15.4px] whitespace-nowrap">
                      EN
                    </div>
                  </div>

                  <div className="absolute w-[38px] h-[38px] top-[58px] left-[1155px] rounded-[18.88px] border-[2.52px] border-solid border-[#00345c] flex items-center justify-center">
          ...
          {/* Navigation */}
          <div className="flex flex-col w-[1371px] h-[41px] items-start gap-2.5 px-[249px] py-3.5 absolute top-[149px] left-[53px] bg-[#0889a5] rounded-lg">
            <div className="relative w-[861px] h-[13px]">
              {/* {navItems.map((item, index) => (
                <Button
                  ...
                  className={`absolute top-0 left-[${
                    index * 150
                  }px] [font-family:'Inter',Helvetica] font-semibold text-white text-[14.1px] tracking-[0] leading-[12.9px] whitespace-nowrap p-0 h-auto`}
                  style={{
                    left: `${
                      index === 0
                        ? 0
...
<div className="relative group">
  <Button
    variant="link"
    className="[font-family:'Inter',Helvetica] absolute font-semibold text-white text-[14.1px] tracking-[0] leading-[12.9px] whitespace-nowrap p-0 h-auto"
  ...
  <div className="absolute top-[30px] left-0 z-50 hidden group-hover:flex flex-wrap gap-6 w-[900px] p-6 bg-white shadow-xl rounded-md border">
    {/* 4 Boxes inside Panel */}
    
    {[...Array(4)].map((_, i) => (
      <div
        key={i}
        className={`w-[200px] p-4 rounded-md ${
          i === 0 ? 'bg-[#e8f5fb]' : ''
        }`}
      >
        <h4 className="font-bold text-[#0889a5] text-sm mb-1">CONFERENCE</h4>
        <p className="text-[12px] text-[#2e2e2e] leading-snug">
  ...
  return (
    <Button
      key={index}
      variant="link"
      className="[font-family:'Inter',Helvetica] font-semibold text-white text-[14.1px] tracking-[0] leading-[12.9px] whitespace-nowrap p-0 h-auto"
      style={{
        position: "absolute",
        left: `${
          index === 1
